...
const DocumentMetadataContext = react_1.default.createContext({
    baseUrl: '',
    baseTarget: '_self',
    lang: 'en',
    links: [],
...
function useDocumentMetadata() {
    return (0, react_1.useContext)(DocumentMetadataContext);
}
exports.default = DocumentMetadataProvider;
